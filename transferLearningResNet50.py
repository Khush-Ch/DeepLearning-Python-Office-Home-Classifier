...
class TransferLearning:
	...
	def build(width, height, depth, classes):
		...
		base_model = ResNet50(input_shape=inputShape, include_top=False, weights="imagenet", classes=65)
		base_model.trainable = False
		global_average_layer = GlobalAveragePooling2D()(base_model.output)
		
		x = Dense(units=1024, activation='relu')(global_average_layer)
		...
		x = Dropout(0.2)(x)
		prediction_layer = Dense(units=65, activation='softmax')(x)
